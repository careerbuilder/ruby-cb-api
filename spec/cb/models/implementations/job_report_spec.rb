...
describe Cb::Models::JobReport do
  ...
  context 'when the response json comes back correctly' do
    ...
    it 'parses fields correctly' do
      ...
      expect(model.competition_information.salary_information.applicant_salaries[0]).to be_a(Cb::Models::ApplicantSalary)
      expect(model.competition_information.salary_information.degree_salaries[0]).to be_a(Cb::Models::DegreeSalary)
